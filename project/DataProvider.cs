...
namespace project
{
    public class DataProvider
    {
        ...
        public DataProvider()
        {
            try
            {
                connection.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Full Code Đồ Án 4\DoAnCaffe\DoAn\project\QL_QUANCAFE.mdf;Integrated Security=True";
                connection.Open();
            }
            catch { }
        }
